...
export default function Hero() {
  ...
  return (
    <div className="relative h-[45vh] md:h-screen bg-gray-900 pt-16 md:pt-0 overflow-x-hidden">
        ...
        <div className="relative w-full h-full">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              {/* Mobile View */}
              <div className="md:hidden flex flex-col items-center space-y-3 px-8">
                <h2 className="text-base font-bold text-white">
                  {slides[currentSlide].title}
                </h2>
                <h3 className="text-lg font-bold text-white/90 leading-tight text-center">
                  {slides[currentSlide].subtitle}
                </h3>
                <p className="text-[10px] text-white/80 leading-snug max-w-[200px] text-center">
                  Leading provider of industrial machinery solutions in Pakistan
                </p>
                <motion.button
                  whileTap={{ scale: 0.95 }}
                  className="mt-1 bg-industrial-secondary text-white px-4 py-1.5 rounded-full text-xs 
                    font-medium flex items-center space-x-1 shadow-lg"
                >
